/*
 * ════════════════════════════════════════════════════════════════
 *  ESP32 — Multi-Sensor Monitor  |  IoT Platform
 ...
 *    • WiFi              — part of ESP32 board package
 *    • HTTPClient        — part of ESP32 board package
 *    • WiFiClientSecure  — part of ESP32 board package
...
float readGas() {
  // TODO: e.g. return analogRead(34) * (3.3/4095.0) * 100;
  return 350.0;
}
...
void setup() {
  ...
  Serial.println(F("\n══════════════════════════════════"));
  Serial.println(F("  ESP32 Multi-Sensor Monitor"));
